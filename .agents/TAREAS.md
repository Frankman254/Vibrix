...
| 1C       | Partículas, lluvia, Stage FX, Camera FX, overlays, fondo global, slideshow/escenas, Looks | **En curso** — overlays hechos (verificados contra el preview); el resto avisa en el planner       |
...
3. 1C, siguiente capa: fondo global → slideshow → Stage FX → Camera FX →
