...
| 1C       | Partículas, lluvia, Stage FX, Camera FX, overlays, fondo global, slideshow/escenas, Looks | **En curso** — overlays y fondo global hechos (verificados contra el preview); el resto avisa en el planner |
...
3. 1C, siguiente capa: slideshow → Stage FX → Camera FX →
