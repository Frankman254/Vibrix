...
**As of:** `chore/fase-0-higiene` (`main`) · App `0.6.0-alpha` · Store persist **v122**
...
| Zustand + `localStorage` persist | Stable | `STORE_PERSIST_VERSION = 122`                               |
...
| `STORE_PERSIST_VERSION`   | **122**       | Migrations in `wallpaperStoreMigrations.ts` |
