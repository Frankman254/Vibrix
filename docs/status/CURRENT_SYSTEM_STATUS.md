...
**As of:** `chore/fase-0-higiene` (`main`) · App `0.6.0-alpha` · Store persist **v123**
...
| Zustand + `localStorage` persist | Stable | `STORE_PERSIST_VERSION = 123`                               |
...
| `STORE_PERSIST_VERSION`   | **123**       | Migrations in `wallpaperStoreMigrations.ts` |
