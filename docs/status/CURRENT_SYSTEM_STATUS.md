...
**As of:** `chore/fase-0-higiene` (`main`) · App `0.4.1-alpha` · Store persist **v114**
...
| Zustand + `localStorage` persist | Stable | `STORE_PERSIST_VERSION = 114`                               |
...
| `STORE_PERSIST_VERSION`   | **114**       | Migrations in `wallpaperStoreMigrations.ts` |
